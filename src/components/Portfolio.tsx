    ...
    <section id="portfolio" className="section bg-[var(--bg-secondary)]">
      <div className="container-custom">
        ...
        <p className="section-subtitle max-w-3xl mb-8">
          All logos in this portfolio (open-source + private) were generated by the <code>logo-designer</code> skill in the <a href="https://github.com/luongnv89/skills" target="_blank" rel="noopener noreferrer" className="underline">skills repository</a>.
        </p>
