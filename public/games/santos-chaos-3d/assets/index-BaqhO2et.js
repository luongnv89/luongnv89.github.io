...
void main() {
	...
	`}var Lo=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var cc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function lc(e,t){let n=cc[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var uc=new U;function dc(){return G.getLuminanceCoefficients(uc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${uc.x.toFixed(4)}, ${uc.y.toFixed(4)}, ${uc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Od=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},kd=new Fa(-1,1,1,-1,0,1),Ad=new class extends Ir{constructor(){super(),this.setAttribute(`position`,new wr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new wr([0,2,0,0,2,0],2))}},jd=class{constructor(e){this._mesh=new q(Ad,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,kd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Md=class extends Od{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ea?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Zi.clone(e.uniforms),this.material=new ea({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new jd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Nd=class extends Od{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Pd=class extends Od{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Fd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new H);this._width=n.width,this._height=n.height,t=new tn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:T}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Md(Dd),this.copyPass.material.blending=0,this.timer=new Ua}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Nd!==void 0&&(r instanceof Nd?n=!0:r instanceof Pd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new H);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Id=class extends Od{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Ld={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},Rd=class e extends Od{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new H(256,256):new H(e.x,e.y),this.clearColor=new K(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new tn(i,a,{type:T}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new tn(i,a,{type:T});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new tn(i,a,{type:T});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=Ld;this.highPassUniforms=Zi.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new ea({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new H(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new U(1,1,1),new U(1,1,1),new U(1,1,1),new U(1,1,1),new U(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Zi.clone(Dd.uniforms),this.blendMaterial=new ea({uniforms:this.copyUniforms,vertexShader:Dd.vertexShader,fragmentShader:Dd.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new K,this._oldClearAlpha=1,this._basic=new fi,this._fsQuad=new jd(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new H(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new ea({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new H(.5,.5)},direction:{value:new H(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};Rd.BlurDirectionX=new H(1,0),Rd.BlurDirectionY=new H(0,1);var zd={name:`FXAAShader`,uniforms:{tDiffuse:{value:null},resolution:{value:new H(1/1024,1/512)}},vertexShader:`
		...
		}`};function Bd(e,t={}){return new na({color:e,roughness:t.roughness??.55,metalness:t.metalness??.15,emissive:t.emissive??0,emissiveIntensity:t.emissiveIntensity??0,transparent:t.transparent??!1,opacity:t.opacity??1})}function Vd({color:e=2766152,accent:t=14701155,police:n=!1,crew:r=!1,name:i=`car`}={}){let a=new Nn;a.name=i;let o=Bd(e,{roughness:.32,metalness:.58}),s=Bd(11065584,{roughness:.12,metalness:.75,transparent:!0,opacity:.62}),c=Bd(1119e3,{roughness:.9,metalness:.1}),l=new q(new Bi(2.1,.55,1.05),o);l.position.y=.45,l.castShadow=!0,l.receiveShadow=!0,a.add(l);let u=new q(new Bi(1.1,.45,.95),s);u.position.set(-.15,.9,0),u.castShadow=!0,a.add(u);let d=r||n?t:16777215,f=new q(new Bi(.9,.04,1.02),Bd(d,{roughness:.3,metalness:.6,emissive:d,emissiveIntensity:r?.45:.12}));f.position.set(.55,.74,0),a.add(f);let p=new Vi(.28,.28,.22,12);for(let[e,t,n]of[[.65,.28,.55],[.65,.28,-.55],[-.65,.28,.55],[-.65,.28,-.55]]){let r=new q(p,c);r.rotation.z=Math.PI/2,r.position.set(e,t,n),r.castShadow=!0,a.add(r)}if(n){let e=new q(new Bi(.7,.12,.35),Bd(2238515,{roughness:.4}));e.position.set(-.1,1.2,0),a.add(e);let t=new q(new Bi(.28,.1,.28),Bd(Tl.cop,{emissive:Tl.cop,emissiveIntensity:1.4}));t.position.set(-.22,1.28,0),t.name=`lightBlue`,a.add(t);let n=new q(new Bi(.28,.1,.28),Bd(Tl.threat,{emissive:Tl.threat,emissiveIntensity:1.4}));n.position.set(.02,1.28,0),n.name=`lightRed`,a.add(n)}let m=Bd(16774872,{emissive:16773312,emissiveIntensity:1.35});for(let e of[.35,-.35]){let t=new q(new Bi(.08,.12,.18),m);t.position.set(1.05,.48,e),a.add(t)}if(r){let e=new Pa(16771256,1.4,12,2);e.position.set(1.4,.55,0),a.add(e)}if(r){let t=new q(new Gi(1.35,.07,8,36),Bd(e,{emissive:e,emissiveIntensity:1.1,roughness:.35}));t.rotation.x=-Math.PI/2,t.position.y=.08,t.name=`ring`,t.visible=!1,a.add(t)}return a.userData.radius=1.15,a.userData.isCar=!0,a}function Hd(e,t=`crew`){return Vd({color:e,accent:e,crew:!0,name:t})}function Ud(){let e=new Nn,t=Bd(6977160,{roughness:.3,metalness:.85}),n=Bd(Tl.accent,{roughness:.35,metalness:.7,emissive:Tl.accent,emissiveIntensity:.35}),r=new q(new Vi(1.1,1.1,.35,28),t);r.rotation.x=Math.PI/2,r.position.set(0,1.1,0),r.castShadow=!0,e.add(r);let i=new q(new Gi(1.15,.08,8,32),n);i.position.set(0,1.1,.18),e.add(i);let a=new q(new Gi(.35,.06,8,20),n);a.position.set(0,1.1,.28),e.add(a);let o=new q(new Vi(.9,1,.2,16),t);return o.position.y=.1,o.receiveShadow=!0,e.add(o),e.userData.gold=n,e}function Wd(e,t=``){let n=new Nn,r=new q(new Vi(.08,.35,2.4,10),Bd(e,{emissive:e,emissiveIntensity:.7,transparent:!0,opacity:.75}));r.position.y=1.2,n.add(r);let i=new q(new Gi(.7,.05,8,28),Bd(e,{emissive:e,emissiveIntensity:.9}));if(i.rotation.x=-Math.PI/2,i.position.y=.05,n.add(i),t){let e=document.createElement(`canvas`);e.width=256,e.height=64;let r=e.getContext(`2d`);r.fillStyle=`rgba(11,16,32,0.75)`,r.fillRect(0,0,256,64),r.fillStyle=`#e8eef4`,r.font=`bold 28px system-ui,sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(t,128,32);let i=new Ii(e);i.colorSpace=qe;let a=new ni(new Hr({map:i,transparent:!0,depthTest:!1}));a.scale.set(3.2,.8,1),a.position.y=2.8,n.add(a),n.userData.sprite=a}return n.userData.beam=r,n.userData.ring=i,n}function Gd(){let e=new Nn,t=Bd(5914672,{roughness:.9}),n=Bd(2976591,{roughness:.7}),r=new q(new Vi(.12,.22,4.2,8),t);r.position.y=2.1,r.castShadow=!0,e.add(r);for(let t=0;t<7;t+=1){let r=new q(new Hi(.15,2.2,6),n);r.position.set(0,4,0),r.rotation.z=.85,r.rotation.y=t/7*Math.PI*2,r.castShadow=!0,e.add(r)}return e}function Kd(){let e=new Nn,t=Bd(2764860,{roughness:.5,metalness:.4}),n=new q(new Vi(.06,.08,4.5,8),t);n.position.y=2.25,n.castShadow=!0,e.add(n);let r=new q(new Bi(1.2,.06,.06),t);r.position.set(.5,4.4,0),e.add(r);let i=new q(new Wi(.18,10,8),Bd(16773320,{emissive:16769184,emissiveIntensity:2}));i.position.set(1,4.25,0),e.add(i);let a=new Pa(16770232,3.2,18,1.8);return a.position.copy(i.position),a.castShadow=!1,e.add(a),e.userData.light=a,e}function qd(e=!1){return new q(new Wi(.08,6,6),Bd(e?Tl.threat:16773800,{emissive:e?Tl.threat:16773800,emissiveIntensity:1.5}))}function Jd(){return new q(new Wi(.06,4,4),Bd(16771232,{emissive:16764006,emissiveIntensity:2}))}var Yd=[3818840,12868682,4881497,5925514,11569724,6961754,2788010,8947856];function Xd(e,t){if(t.has(e))throw TypeError(`Cannot initialize the same private elements twice on an object`)}function Zd(e,t){Xd(e,t),t.add(e)}function Qd(e,t,n){if(typeof e==`function`?e===t:e.has(t))return arguments.length<3?t:n;throw TypeError(`Private element is not present on this object`)}function $d(){return typeof matchMedia==`function`&&matchMedia(`(prefers-reduced-motion: reduce)`).matches}var ef={uniforms:{tDiffuse:{value:null},offset:{value:1.05},darkness:{value:.85}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},tf=new WeakSet,nf=class{constructor(e,t){Zd(this,tf),this.host=e,this.assets=t,this.reduced=$d(),this.elapsed=0,this.colliders=[],this.followTarget=new U(pf.x,0,pf.z),this.camOffset=new U(0,Z.cameraHeight,Z.cameraDistance),this._look=new U,this._desiredCam=new U,Qd(tf,this,rf).call(this),Qd(tf,this,af).call(this),Qd(tf,this,of).call(this),Qd(tf,this,sf).call(this),Qd(tf,this,cf).call(this),Qd(tf,this,lf).call(this),Qd(tf,this,uf).call(this),Qd(tf,this,df).call(this),Qd(tf,this,ff).call(this),this.resize(),window.addEventListener(`resize`,()=>this.resize())}setVaultOpen(e){this.vaultMesh?.userData?.gold&&(this.vaultMesh.userData.gold.emissiveIntensity=e?1.2:.35,this.vaultMesh.userData.gold.color.setHex(e?8978363:Tl.accent))}setSideDone(e){this.sideMarker.visible=!e}setFollow(e,t,n=0){this.followTarget.set(e,0,t),this.followFacing=n}resolveCollision(e,t,n=.45){let r=e,i=t;for(let e=0;e<3;e+=1)for(let e of this.colliders){let t=e.minX-n,a=e.maxX+n,o=e.minZ-n,s=e.maxZ+n;if(r>t&&r<a&&i>o&&i<s){let e=r-t,n=a-r,c=i-o,l=s-i,u=Math.min(e,n,c,l);u===e?r=t:u===n?r=a:i=u===c?o:s}}return r=Ft.clamp(r,1,X.width-1),i=Ft.clamp(i,1,X.depth-1),{x:r,z:i}}pulseMarkers(e){let t=1+Math.sin(e*3.2)*.08;this.vaultMarker.visible&&(this.vaultMarker.scale.setScalar(t),this.vaultMarker.rotation.y=e*.6),this.safeMarker.scale.setScalar(.95+(1-(t-1))*.5),this.safeMarker.rotation.y=-e*.4,this.sideMarker.visible&&(this.sideMarker.scale.setScalar(t),this.sideMarker.rotation.y=e*.8)}update(e){this.elapsed+=e,this.pulseMarkers(this.elapsed);let t=this.followFacing??0,n=-Math.sin(t)*Z.cameraDistance*.35,r=-Math.cos(t)*Z.cameraDistance*.35;this._desiredCam.set(this.followTarget.x+n,Z.cameraHeight,this.followTarget.z+Z.cameraDistance*.85+r*.2);let i=1-Math.exp(-Z.cameraLag*e);this.camera.position.lerp(this._desiredCam,i),this._look.set(this.followTarget.x,1.2,this.followTarget.z),this.camera.lookAt(this._look),this.moon&&(this.moon.target.position.lerp(this.followTarget,i),this.moon.target.updateMatrixWorld())}resize(){let e=Math.max(1,this.host.clientWidth||window.innerWidth),t=Math.max(1,this.host.clientHeight||window.innerHeight);this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t);let n=this.renderer.getPixelRatio();this.fxaaPass&&this.fxaaPass.material.uniforms.resolution.value.set(1/(e*n),1/(t*n)),this.bloomPass&&this.bloomPass.resolution.set(e,t)}render(){this.composer?this.composer.render():this.renderer.render(this.scene,this.camera)}add(e){this.scene.add(e)}remove(e){this.scene.remove(e)}};function rf(){this.renderer=new xl({antialias:!this.reduced,powerPreference:`high-performance`,alpha:!1}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,this.reduced?1.5:2)),this.renderer.outputColorSpace=qe,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.45,this.renderer.shadowMap.enabled=!this.reduced,this.renderer.shadowMap.type=2,this.renderer.setClearColor(1186350,1),this.host.appendChild(this.renderer.domElement),this.renderer.domElement.style.display=`block`,this.renderer.domElement.style.width=`100%`,this.renderer.domElement.style.height=`100%`}function af(){this.scene=new Hn,this.scene.background=new K(1713208),this.scene.fog=new Vn(1713208,.0065),this.camera=new Ma(48,1,.2,280),this.camera.position.set(20,Z.cameraHeight,30);let e=new Wi(200,24,16),t=new ea({side:1,depthWrite:!1,uniforms:{topColor:{value:new K(1845834)},bottomColor:{value:new K(3811912)},offset:{value:8},exponent:{value:.5}},vertexShader:`
        varying vec3 vWorldPosition;
        void main() {
      ...
      `,fragmentShader:`
        ...
        void main() {
          ...
          vec3 mid = vec3(0.32, 0.18, 0.38);
          vec3 col = mix(bottomColor, mid, smoothstep(0.0, 0.35, t));
          col = mix(col, topColor, smoothstep(0.2, 1.0, t));
          gl_FragColor = vec4(col, 1.0);
        }
      `});this.scene.add(new q(e,t))}function of(){let e=new ba(11584744,3813448,1.05);this.scene.add(e),this.moon=new La(15265528,1.75),this.moon.position.set(-40,55,25),this.moon.castShadow=!this.reduced,this.moon.castShadow&&(this.moon.shadow.mapSize.set(2048,2048),this.moon.shadow.camera.near=5,this.moon.shadow.camera.far=160,this.moon.shadow.camera.left=-55,this.moon.shadow.camera.right=55,this.moon.shadow.camera.top=55,this.moon.shadow.camera.bottom=-55,this.moon.shadow.bias=-2e-4,this.moon.shadow.normalBias=.03),this.scene.add(this.moon),this.scene.add(this.moon.target);let t=new La(16747224,.42);t.position.set(30,18,-20),this.scene.add(t);let n=new La(16767392,.35);n.position.set(-20,14,30),this.scene.add(n);let r=new Ra(6978200,.55);this.scene.add(r)}function sf(){let e=new q(new Ui(X.width+20,X.depth+20),new na({map:this.assets.asphalt,roughnessMap:this.assets.rough,roughness:.88,metalness:.1,color:13160668}));e.rotation.x=-Math.PI/2,e.position.set(X.width/2,0,X.depth/2),e.receiveShadow=!0,this.scene.add(e);let t=new na({color:2765636,roughness:.85,metalness:.05}),n=[{x:X.width/2,z:-1.5,w:X.width+4,d:3},{x:X.width/2,z:X.depth+1.5,w:X.width+4,d:3},{x:-1.5,z:X.depth/2,w:3,d:X.depth+4},{x:X.width+1.5,z:X.depth/2,w:3,d:X.depth+4}];for(let e of n){let n=new q(new Bi(e.w,.4,e.d),t);n.position.set(e.x,.2,e.z),n.receiveShadow=!0,this.scene.add(n),this.colliders.push(mf(e.x,e.z,e.w,e.d))}}function cf(){let e=new na({color:2766152,roughness:.9,metalness:.08}),t=new fi({map:this.assets.lane,transparent:!0,opacity:.9,depthWrite:!1});for(let n of Nl){let r=new q(new Bi(X.width,.04,5.5),e);r.position.set(X.width/2,.02,n),r.receiveShadow=!0,this.scene.add(r);let i=new q(new Ui(X.width,.35),t);i.rotation.x=-Math.PI/2,i.position.set(X.width/2,.05,n),this.scene.add(i)}for(let t of Pl){let n=new q(new Bi(5.5,.04,X.depth),e);n.position.set(t,.015,X.depth/2),n.receiveShadow=!0,this.scene.add(n)}}function lf(){this.buildingMeshes=[];let e=new na({color:1712688,roughness:.75,metalness:.25});for(let t of Dl){let n=new na({map:this.assets.facade,roughness:.7,metalness:.2,emissive:t.bank?new K(Tl.player):new K(660768),emissiveIntensity:t.bank?.12:.05});n.map=this.assets.facade.clone(),n.map.offset.set(Math.random(),Math.random()),n.map.needsUpdate=!0;let r=new q(new Bi(t.w,t.h,t.d),[n,n,e,e,n,n]);if(r.position.set(t.x,t.h/2,t.z),r.castShadow=!0,r.receiveShadow=!0,this.scene.add(r),this.buildingMeshes.push(r),this.colliders.push(mf(t.x,t.z,t.w-.2,t.d-.2)),t.h>6||t.bank){let e=t.bank?Tl.player:Math.random()>.5?Tl.neonCyan:Tl.neonMagenta,n=new q(new Bi(t.w*.92,.12,t.d*.92),new na({color:e,emissive:e,emissiveIntensity:1.1,roughness:.3,metalness:.5}));n.position.set(t.x,t.h+.05,t.z),this.scene.add(n)}if(t.bank){let e=new q(new Ui(6,1.5),new fi({map:this.assets.fleeca,transparent:!0,side:2}));e.position.set(t.x,t.h*.72,t.z+t.d/2+.08),this.scene.add(e);let n=new q(new Bi(5,.08,3),new na({color:2766152,roughness:.6,metalness:.2}));n.position.set(t.x,.04,t.z+t.d/2+1.4),n.receiveShadow=!0,this.scene.add(n);let r=new Pa(Tl.player,4,22,1.8);r.position.set(t.x,3.5,t.z+t.d/2+1),this.scene.add(r)}}}function uf(){for(let[e,t]of[[5,15],[5,34],[5,55],[35,15],[35,55],[80,15],[80,34],[105,55],[25,72],[60,72],[95,72],[17,20],[47,20],[72,20],[97,38]]){let n=Gd();n.position.set(e,0,t),n.rotation.y=Math.random()*Math.PI,n.scale.setScalar(.85+Math.random()*.3),this.scene.add(n)}for(let e of Nl)for(let t=6;t<X.width;t+=14){if(this.colliders.some(n=>t>n.minX&&t<n.maxX&&e>n.minZ&&e<n.maxZ))continue;let n=Kd();n.position.set(t,0,e-2.8),this.reduced&&(n.userData.light.intensity=.6),this.scene.add(n)}}function df(){this.vaultMesh=Ud(),this.vaultMesh.position.set(kl.x,0,kl.z),this.scene.add(this.vaultMesh),this.vaultMarker=Wd(Tl.accent,`VAULT`),this.vaultMarker.position.set(kl.x,0,kl.z),this.scene.add(this.vaultMarker),this.safeMarker=Wd(Tl.accent,`SAFEHOUSE`),this.safeMarker.position.set(Al.x,0,Al.z),this.scene.add(this.safeMarker);let e=new q(new Vi(3.2,3.2,.12,28),new na({color:Tl.accent,emissive:Tl.accent,emissiveIntensity:.35,roughness:.5,metalness:.3,transparent:!0,opacity:.55}));e.position.set(Al.x,.06,Al.z),this.scene.add(e);let t=new q(new Ui(3.5,.9),new fi({map:this.assets.safe,transparent:!0,side:2}));t.position.set(Al.x,2.2,Al.z),this.scene.add(t),this.sideMarker=Wd(Tl.neonAmber,`SIDE JOB`),this.sideMarker.position.set(jl.x,0,jl.z),this.scene.add(this.sideMarker)}function ff(){this.composer=new Fd(this.renderer),this.composer.addPass(new Id(this.scene,this.camera));let e=new H;this.renderer.getSize(e),this.bloomPass=new Rd(e,.38,.4,.82),this.reduced&&(this.bloomPass.strength=.18,this.bloomPass.threshold=.92),this.composer.addPass(this.bloomPass),this.vignettePass=new Md(ef),this.vignettePass.uniforms.offset.value=1.15,this.vignettePass.uniforms.darkness.value=.55,this.composer.addPass(this.vignettePass),this.fxaaPass=new Md(zd),this.composer.addPass(this.fxaaPass)}var pf={x:10,z:18};function mf(e,t,n,r){return{minX:e-n/2,maxX:e+n/2,minZ:t-r/2,maxZ:t+r/2}}var hf=new WeakSet,gf=class{constructor(e=document.getElementById(`ui`)){Zd(this,hf);let t=Z.minimapSize??148;this.size=t;let n=document.createElement(`div`);n.id=`minimap`,n.setAttribute(`aria-label`,`Minimap`),n.innerHTML=`<span class="minimap-label">RADAR</span>`;let r=document.createElement(`canvas`);r.width=t*2,r.height=t*2,r.style.width=`${t}px`,r.style.height=`${t}px`,n.append(r),e?.append(n),this.wrap=n,this.canvas=r,this.ctx=r.getContext(`2d`),this.scaleX=t*2/X.width,this.scaleZ=t*2/X.depth}draw({player:e,crooks:t,cops:n,traffic:r,vaultOpen:i,hasTake:a,sideDone:o}){let{ctx:s,canvas:c,size:l}=this,u=c.width,d=c.height;s.clearRect(0,0,u,d),s.fillStyle=`rgba(8, 14, 28, 0.92)`,s.fillRect(0,0,u,d),s.fillStyle=`rgba(40, 52, 72, 0.95)`;for(let e of Nl){let t=Qd(hf,this,vf).call(this,e);s.fillRect(0,t-5,u,10)}for(let e of Pl){let t=Qd(hf,this,_f).call(this,e);s.fillRect(t-5,0,10,d)}s.fillStyle=`rgba(70, 88, 118, 0.85)`;for(let e of Dl){let t=Qd(hf,this,_f).call(this,e.x-e.w/2),n=Qd(hf,this,vf).call(this,e.z-e.d/2),r=e.w*this.scaleX,i=e.d*this.scaleZ;e.bank?(s.fillStyle=`rgba(242, 193, 78, 0.55)`,s.fillRect(t,n,r,i),s.strokeStyle=`rgba(242, 193, 78, 0.9)`,s.lineWidth=2,s.strokeRect(t,n,r,i),s.fillStyle=`rgba(70, 88, 118, 0.85)`):s.fillRect(t,n,r,i)}Qd(hf,this,yf).call(this,kl.x,kl.z,i||a?`#88ffbb`:`#5cdb95`,i?5:6,!0),Qd(hf,this,yf).call(this,Al.x,Al.z,`#5cdb95`,6,!0),o||Qd(hf,this,yf).call(this,jl.x,jl.z,`#ffb347`,5,!0),s.fillStyle=`rgba(160, 170, 190, 0.45)`;for(let e of r||[])e.mesh?.visible&&s.fillRect(Qd(hf,this,_f).call(this,e.x)-2,Qd(hf,this,vf).call(this,e.z)-2,4,4);for(let e of n||[])e.alive&&Qd(hf,this,yf).call(this,e.x,e.z,`#4a90e2`,4);for(let n=0;n<(t||[]).length;n+=1){let r=t[n];if(!r.alive)continue;let i=Fl[n]?.color||`#f2c14e`,a=r===e;if(Qd(hf,this,yf).call(this,r.x,r.z,i,a?6:4,a),a){let e=r.facing??0,t=Qd(hf,this,_f).call(this,r.x),n=Qd(hf,this,vf).call(this,r.z);s.save(),s.translate(t,n),s.rotate(e),s.fillStyle=i,s.beginPath(),s.moveTo(0,10),s.lineTo(-5,2),s.lineTo(5,2),s.closePath(),s.fill(),s.restore()}}s.strokeStyle=`rgba(92, 219, 149, 0.55)`,s.lineWidth=3,s.strokeRect(1.5,1.5,u-3,d-3)}};function _f(e){return e*this.scaleX}function vf(e){return e*this.scaleZ}function yf(e,t,n,r=4,i=!1){let{ctx:a}=this,o=Qd(hf,this,_f).call(this,e),s=Qd(hf,this,vf).call(this,t);i&&(a.beginPath(),a.fillStyle=n,a.globalAlpha=.25,a.arc(o,s,r+5,0,Math.PI*2),a.fill(),a.globalAlpha=1),a.beginPath(),a.fillStyle=n,a.arc(o,s,r,0,Math.PI*2),a.fill(),a.strokeStyle=`rgba(255,255,255,0.35)`,a.lineWidth=1,a.stroke()}var bf=new WeakSet,xf=class{constructor(e){Zd(this,bf),this.host=e,this.assets=Ul(),this.city=new nf(e,this.assets),this.minimap=new gf(document.getElementById(`ui`)),this.crooks=[],this.traffic=[],this.cops=[],this.bullets=[],this.sparks=[],this.promptEl=null,Qd(bf,this,Sf).call(this),Qd(bf,this,Cf).call(this),Qd(bf,this,wf).call(this);let t=su();this.resetRun(),t&&this.restore(t),lu(()=>this.state===`over`?null:this.snapshot()),this.refreshHud()}levelIndex(){return this.hasTake?2:+!!this.vaultOpen}levelTuning(){return Z.levels[this.levelIndex()]??Z.levels[0]}resetRun(){this.state=`ready`,this.score=0,this.cash=0,this.heat=0,this.elapsed=0,this.vaultProgress=0,this.vaultOpen=!1,this.hasTake=!1,this.sideDone=!1,this.vaultAlarmFired=!1,this.fireReadyAt=0,this.facing=Math.PI/2,this.activeIndex=0,this.flashMs=0;for(let e of this.bullets)this.city.remove(e.mesh);this.bullets=[];for(let e of this.cops)this.city.remove(e.mesh);this.cops=[];for(let e of this.sparks)this.city.remove(e.mesh);this.sparks=[];for(let e=0;e<this.crooks.length;e+=1){let t=this.crooks[e];t.x=Ml[e].x,t.z=Ml[e].z,t.hp=Z.crookHp,t.alive=!0,t.facing=Math.PI/2,t.mesh.visible=!0,t.mesh.position.set(t.x,0,t.z),t.mesh.rotation.y=t.facing-Math.PI/2}this.switchTo(0,!0),this.city.setVaultOpen(!1),this.city.setSideDone(!1),this.traffic.forEach(e=>{e.x=4+Math.random()*(X.width-8),e.z=e.laneZ,e.mesh.position.set(e.x,0,e.z),e.mesh.visible=!0}),cu(),this.refreshHud()}begin(){this.state!==`over`&&(this.state=`playing`,Ed(),this.refreshHud(),bu(`ui`))}setPaused(e){this.state!==`over`&&(this.state=e?`paused`:`playing`,e&&ou(this.snapshot()))}snapshot(){return{score:this.score,cash:this.cash,heat:this.heat,elapsed:this.elapsed,vaultOpen:this.vaultOpen,hasTake:this.hasTake,sideDone:this.sideDone,activeIndex:this.activeIndex,crooks:this.crooks.map(e=>({x:+e.x.toFixed(2),z:+e.z.toFixed(2),hp:e.hp,alive:e.alive,facing:+e.facing.toFixed(3)}))}}restore(e){this.score=e.score??0,this.cash=e.cash??0,this.heat=e.heat??0,this.elapsed=e.elapsed??0,this.vaultOpen=!!e.vaultOpen,this.hasTake=!!e.hasTake,this.sideDone=!!e.sideDone,(e.crooks??[]).forEach((e,t)=>{let n=this.crooks[t];n&&(n.x=e.x,n.z=e.z,n.hp=e.hp??Z.crookHp,n.alive=e.alive!==!1,n.facing=e.facing??Math.PI/2,n.mesh.position.set(n.x,0,n.z),n.mesh.visible=n.alive)}),this.city.setVaultOpen(this.vaultOpen),this.city.setSideDone(this.sideDone);let t=e.activeIndex??0;this.switchTo(this.crooks[t]?.alive?t:this.firstAlive(),!0),this.syncHeatCops(),this.refreshHud()}firstAlive(){let e=this.crooks.findIndex(e=>e.alive);return e>=0?e:0}get player(){return this.crooks[this.activeIndex]}switchTo(e,t=!1){let n=this.crooks[e];if(!n||!n.alive){t||bu(`drop`);return}this.activeIndex=e;for(let e of this.crooks){let t=e.mesh.getObjectByName(`ring`);t&&(t.visible=e===n),e.mesh.scale.setScalar(e===n?1:.94)}t||bu(`switch`),this.refreshHud()}tryFire(e){if(e<this.fireReadyAt)return;this.fireReadyAt=e+Z.fireCooldownMs;let t=this.player,n=t.facing,r=qd(!1),i=t.x+Math.sin(n)*1.6,a=t.z+Math.cos(n)*1.6;r.position.set(i,.7,a),this.city.add(r),this.bullets.push({mesh:r,x:i,z:a,y:.7,vx:Math.sin(n)*Z.bulletSpeed,vz:Math.cos(n)*Z.bulletSpeed,life:.9,fromPlayer:!0}),this.heat=Math.min(Z.heatMax,this.heat+Z.heatPerShot),bu(`shoot`),this.burstSparks(i,.7,a,4),this.syncHeatCops(),this.refreshHud()}fireCopBullet(e,t){let n=qd(!0),r=e.x+Math.sin(t)*1.2,i=e.z+Math.cos(t)*1.2;n.position.set(r,.7,i),this.city.add(n),this.bullets.push({mesh:n,x:r,z:i,y:.7,vx:Math.sin(t)*Z.bulletSpeed*.75,vz:Math.cos(t)*Z.bulletSpeed*.75,life:.8,fromPlayer:!1})}burstSparks(e,t,n,r=6){if(!md())for(let i=0;i<r;i+=1){let r=Jd();r.position.set(e,t,n),this.city.add(r),this.sparks.push({mesh:r,vx:(Math.random()-.5)*6,vy:2+Math.random()*4,vz:(Math.random()-.5)*6,life:.25+Math.random()*.2})}}damageCrook(e,t){if(e.alive){if(e.hp=Math.max(0,e.hp-t),this.flashMs=80,bu(`hurt`),e===this.player&&!this.vaultOpen&&this.vaultProgress>0&&(this.vaultProgress=Math.max(0,this.vaultProgress-Z.vaultDamageReset)),e.hp<=0&&(e.alive=!1,e.mesh.visible=!1,bu(`drop`),e===this.player)){let e=this.firstAlive();this.crooks[e]?.alive?this.switchTo(e,!0):this.finish(!1,`The whole crew is wrecked. Heist failed.`)}this.refreshHud()}}stars(){return Math.min(5,Math.floor(this.heat+.001))}desiredCops(){let e=this.stars();if(e<=0)return 0;let t=Z.copBase+(e-1)*Z.copPerStar,n=this.levelTuning().copMult;return Math.min(Z.maxCops,Math.floor(t*n))}syncHeatCops(){let e=this.desiredCops();for(;this.cops.filter(e=>e.alive).length<e;)this.spawnCop()}spawnCop(){let e,t;if(Math.random()>.35)t=Nl[Math.floor(Math.random()*Nl.length)],e=4+Math.random()*(X.width-8);else{let n=Math.floor(Math.random()*4);n===0?(e=Math.random()*X.width,t=2):n===1?(e=Math.random()*X.width,t=X.depth-2):n===2?(e=2,t=Math.random()*X.depth):(e=X.width-2,t=Math.random()*X.depth)}let n=Vd({color:1713984,police:!0});n.position.set(e,0,t),this.city.add(n),this.cops.push({mesh:n,x:e,z:t,facing:0,hp:Z.copHp+this.stars()*8,alive:!0,isCar:!0,shootAt:0,radius:Z.carRadius})}fireVaultAlarm(){if(!this.vaultAlarmFired){this.vaultAlarmFired=!0;for(let e=0;e<Z.vaultAlarmCops;e+=1)this.spawnCop()}}tryInteract(){let e=this.player;if(e?.alive){if(Math.hypot(e.x-kl.x,e.z-kl.z)<Z.interactRange+1.4){if(!this.vaultOpen)return;this.hasTake||(this.hasTake=!0,this.cash+=Z.bankCash,this.score+=Z.bankCash,this.heat=Math.min(Z.heatMax,this.heat+Z.heatPerVault),bu(`cash`),this.burstSparks(kl.x,1.2,kl.z,18),this.syncHeatCops(),this.refreshHud());return}this.sideDone||Math.hypot(e.x-jl.x,e.z-jl.z)<Z.sideJobRange&&(this.sideDone=!0,this.cash+=Z.sideJobCash,this.score+=Z.sideJobCash,this.heat=Math.min(Z.heatMax,this.heat+.4),this.city.setSideDone(!0),bu(`cash`),this.burstSparks(jl.x,1.2,jl.z,12),this.syncHeatCops(),this.refreshHud())}}checkWin(){if(!this.hasTake)return;let e=this.player;if(e&&Math.hypot(e.x-Al.x,e.z-Al.z)<Z.safehouseRange){let e=Math.max(0,Math.floor((Z.winBonusTime-this.elapsed)*10)),t=this.stars()*100;this.score+=1e3+e-t+this.cash,this.finish(!0,`Take delivered. $${this.cash} secured in ${Math.round(this.elapsed)}s with ${this.stars()}★ heat.`)}}finish(e,t){this.state=`over`,cu(),bu(e?`win`:`lose`);let{rank:n}=tu(this.score,{won:e,seconds:Math.round(this.elapsed),cash:this.cash});Cd({title:e?`Safehouse secured`:`Busted`,reason:t,objective:n===1?`New best score!`:`Best so far: ${nu()}`,rank:n}),this.refreshHud()}refreshHud(){let e=`★`.repeat(this.stars())+`☆`.repeat(5-this.stars()),t=this.crooks.filter(e=>e.alive).length,n=Fl[this.activeIndex]?.name??`?`,r=this.levelTuning(),i=this.hasTake?`Deliver the take`:this.vaultOpen?`Grab the cash (F)`:`Drive to the vault`;Uu()?bd(i):bd(`Objective: ${Cl.objective} — ${i}`),xd({Cash:`$${this.cash}`,Heat:e,Crew:`${n} (${t}/3)`,Score:this.score,Best:nu()});let a=0,o=1,s=r.hint;if(this.levelIndex()===0)a=this.vaultProgress,o=1,s=`Crack vault ${Math.floor(this.vaultProgress*100)}%`;else if(this.levelIndex()===1)a=+!!this.hasTake,o=1,s=this.hasTake?`Take secured`:`Grab the cash`;else{let e=this.player,t=e?Math.hypot(e.x-Al.x,e.z-Al.z):80;a=Ft.clamp(1-t/90,0,1),o=1,s=`Race to safehouse`}Sd({label:r.name,value:a,max:o,hint:s})}updatePrompt(){let e=this.player;if(!e?.alive||!this.promptEl){this.promptEl&&(this.promptEl.textContent=``);return}let t=``;Math.hypot(e.x-kl.x,e.z-kl.z)<Z.interactRange+2.2&&(this.vaultOpen?this.hasTake||(t=`F / 🔒 — grab the take`):t=`Hold F / 🔒 — crack vault ${Math.floor(this.vaultProgress*100)}%`),this.sideDone||Math.hypot(e.x-jl.x,e.z-jl.z)<Z.sideJobRange+1.5&&(t=`F / 🔒 — smash & grab`),this.hasTake&&Math.hypot(e.x-Al.x,e.z-Al.z)<Z.safehouseRange+6&&(t=`Safehouse — deliver the take!`),this.promptEl.textContent=t}update(e){let t=Math.min(e,100)/1e3,n=performance.now();this.updateTraffic(t),this.city.update(t);let r=this.player;if(r&&this.city.setFollow(r.x,r.z,r.facing??this.facing),this.minimap.draw({player:this.player,crooks:this.crooks,cops:this.cops,traffic:this.traffic,vaultOpen:this.vaultOpen,hasTake:this.hasTake,sideDone:this.sideDone}),this.state!==`playing`){Vu();return}this.elapsed+=t;let i=this.levelTuning();this.heat>0&&this.stars()<5&&(this.heat=Math.max(0,this.heat-Z.heatDecayPerSec*t*i.heatDecay*(this.hasTake?.35:1))),Ru(`crew1`)&&this.switchTo(0),Ru(`crew2`)&&this.switchTo(1),Ru(`crew3`)&&this.switchTo(2),Ru(`interact`)&&this.tryInteract(),!this.vaultOpen&&this.player?.alive&&(Math.hypot(this.player.x-kl.x,this.player.z-kl.z)<Z.interactRange+1&&Lu(`interact`)?(this.vaultProgress+=e/Z.vaultHoldMs,this.vaultProgress>=1&&(this.vaultProgress=1,this.vaultOpen=!0,this.city.setVaultOpen(!0),this.heat=Math.min(Z.heatMax,this.heat+Z.heatPerVaultCrack),bu(`vault`),this.fireVaultAlarm(),this.syncHeatCops(),this.refreshHud())):this.vaultProgress>0&&this.vaultProgress<1&&(this.vaultProgress=Math.max(0,this.vaultProgress-Z.vaultDecayPerSec*t))),this.updateActiveDrive(t,n),this.updateAiCrew(t),this.updateCops(n,t),this.updateBullets(t),this.updateSparks(t),this.updatePrompt(),this.checkWin(),this.syncMeshes(),this.stars()>=5&&this.crooks.every(e=>!e.alive)&&this.finish(!1,`Max heat. The crew is gone.`),Math.floor(this.elapsed*4)!==Math.floor((this.elapsed-t)*4)&&this.refreshHud(),Vu()}updateActiveDrive(e,t){if(!this.player?.alive)return;let n=Bu(`steerX`,`left`,`right`,e),r=Bu(`steerY`,`up`,`down`,e),i=this.player,a=Math.hypot(n,r);if(a>.12){let t=Math.atan2(n,r)-i.facing;for(;t>Math.PI;)t-=Math.PI*2;for(;t<-Math.PI;)t+=Math.PI*2;let o=Z.driveTurn*e;i.facing+=Ft.clamp(t,-o,o);let s=this.levelTuning().speed??1,c=Z.driveSpeed*s*Math.min(1,a),l=i.x+Math.sin(i.facing)*c*e,u=i.z+Math.cos(i.facing)*c*e,d=this.city.resolveCollision(l,u,Z.carRadius);i.x=d.x,i.z=d.z}this.facing=i.facing,Lu(`fire`)&&this.tryFire(t)}updateAiCrew(e){for(let t=0;t<this.crooks.length;t+=1){let n=this.crooks[t];if(!n.alive||n===this.player)continue;let r=n.x,i=n.z;t===2&&!this.vaultOpen?(r=kl.x+3,i=kl.z+3):t===1&&this.vaultOpen?(r=Ol.x,i=Ol.z+Ol.d/2+3):t===0?(r=Ml[0].x+4,i=Ml[0].z):this.hasTake&&(r=Al.x-4,i=Al.z+2);let a=r-n.x,o=i-n.z;if(Math.hypot(a,o)>2.2){let t=Math.atan2(a,o)-n.facing;for(;t>Math.PI;)t-=Math.PI*2;for(;t<-Math.PI;)t+=Math.PI*2;n.facing+=Ft.clamp(t,-Z.driveTurn*e,Z.driveTurn*e);let r=Z.aiDriveSpeed,i=n.x+Math.sin(n.facing)*r*e,s=n.z+Math.cos(n.facing)*r*e,c=this.city.resolveCollision(i,s,Z.carRadius);n.x=c.x,n.z=c.z}}}updateTraffic(e){let t=this.levelTuning().trafficSpeed;for(let n of this.traffic)n.x+=n.dir*n.speed*t*e,n.z=n.laneZ+Math.sin((n.x+n.z)*.15)*.08,n.x>X.width+2&&(n.x=-2),n.x<-2&&(n.x=X.width+2),n.facing=n.dir>0?Math.PI/2:-Math.PI/2}updateCops(e,t){let n=this.player;if(n)for(let r of this.cops){if(!r.alive)continue;let i=this.levelTuning(),a=Z.copDrive*(i.copMult??i.speed??1),o=Math.atan2(n.x-r.x,n.z-r.z),s=o-r.facing;for(;s>Math.PI;)s-=Math.PI*2;for(;s<-Math.PI;)s+=Math.PI*2;r.facing+=Ft.clamp(s,-2.4*t,2.4*t);let c=r.x+Math.sin(r.facing)*a*t,l=r.z+Math.cos(r.facing)*a*t,u=this.city.resolveCollision(c,l,r.radius);r.x=u.x,r.z=u.z;let d=Math.hypot(r.x-n.x,r.z-n.z);d<2&&this.stars()>=4&&this.damageCrook(this.player,22*t);let f=r.mesh.getObjectByName(`lightBlue`),p=r.mesh.getObjectByName(`lightRed`),m=Math.sin(e*.012)>0;f?.material&&(f.material.emissiveIntensity=m?1.8:.25),p?.material&&(p.material.emissiveIntensity=m?.25:1.8),d<24&&e>(r.shootAt||0)&&(r.shootAt=e+700+Math.random()*500,this.fireCopBullet(r,o))}}updateBullets(e){for(let t=this.bullets.length-1;t>=0;--t){let n=this.bullets[t];n.life-=e,n.x+=n.vx*e,n.z+=n.vz*e,n.mesh.position.set(n.x,n.y,n.z);let r=!1;if(n.fromPlayer){for(let e of this.cops)if(e.alive&&Math.hypot(n.x-e.x,n.z-e.z)<e.radius+.25){e.hp-=25,this.burstSparks(e.x,.8,e.z,8),r=!0,e.hp<=0&&(e.alive=!1,e.mesh.visible=!1,this.score+=50,this.heat=Math.min(Z.heatMax,this.heat+Z.heatPerKill),bu(`hit`),this.syncHeatCops(),this.refreshHud());break}}else for(let e of this.crooks)if(!(!e.alive||!e.mesh.visible)&&Math.hypot(n.x-e.x,n.z-e.z)<Z.carRadius+.2){this.damageCrook(e,18),r=!0;break}if(!r){let e=this.city.resolveCollision(n.x,n.z,.1);Math.hypot(e.x-n.x,e.z-n.z)>.05&&(r=!0)}(r||n.life<=0||n.x<-2||n.z<-2||n.x>X.width+2||n.z>X.depth+2)&&(this.city.remove(n.mesh),n.mesh.geometry?.dispose(),n.mesh.material?.dispose(),this.bullets.splice(t,1))}}updateSparks(e){for(let t=this.sparks.length-1;t>=0;--t){let n=this.sparks[t];n.life-=e,n.mesh.position.x+=n.vx*e,n.mesh.position.y+=n.vy*e,n.mesh.position.z+=n.vz*e,n.vy-=12*e,n.mesh.scale.multiplyScalar(.92),n.life<=0&&(this.city.remove(n.mesh),n.mesh.geometry?.dispose(),n.mesh.material?.dispose(),this.sparks.splice(t,1))}}syncMeshes(){for(let e of this.crooks)e.alive&&(e.mesh.position.set(e.x,0,e.z),e.mesh.rotation.y=e.facing-Math.PI/2);for(let e of this.traffic)e.mesh.position.set(e.x,0,e.z),e.mesh.rotation.y=e.facing-Math.PI/2;for(let e of this.cops)e.alive&&(e.mesh.position.set(e.x,0,e.z),e.mesh.rotation.y=e.facing-Math.PI/2)}render(){this.city.render()}resize(){this.city.resize()}};function Sf(){let e=document.createElement(`div`);e.id=`world-prompt`,e.setAttribute(`aria-live`,`polite`),document.getElementById(`ui`)?.append(e),this.promptEl=e}function Cf(){for(let e=0;e<3;e+=1){let t=Hd(Number.parseInt(Fl[e].color.slice(1),16),Fl[e].name);t.position.set(Ml[e].x,0,Ml[e].z),this.city.add(t),this.crooks.push({mesh:t,index:e,hp:Z.crookHp,alive:!0,facing:Math.PI/2,x:Ml[e].x,z:Ml[e].z})}for(let e=0;e<Z.trafficCount;e+=1){let t=Nl[e%Nl.length],n=Yd[e%Yd.length],r=Vd({color:n}),i=4+Math.random()*(X.width-8);r.position.set(i,0,t),this.city.add(r);let a=e%2==0?1:-1,o=a>0?Math.PI/2:-Math.PI/2;this.traffic.push({mesh:r,x:i,z:t,laneZ:t,dir:a,speed:4+Math.random()*3,facing:o}),r.rotation.y=o-Math.PI/2}}function wf(){Td({onStart:()=>this.begin(),onPause:()=>this.setPaused(!0),onResume:()=>this.setPaused(!1),onRestart:()=>{vd(),this.resetRun(),this.begin()}}),Ku(document.getElementById(`touch`),{stick:!1,buttons:[{action:`left`,label:`◀`,title:`Left`,group:`move`},{action:`right`,label:`▶`,title:`Right`,group:`move`},{action:`up`,label:`▲`,title:`Forward`,group:`move`},{action:`down`,label:`▼`,title:`Back`,group:`move`},{action:`fire`,label:`⚡`,title:`Shoot`,group:`action`},{action:`interact`,label:`🔒`,title:`Interact`,group:`action`},{action:`crew1`,label:`1`,title:`Car 1`,group:`action`},{action:`crew2`,label:`2`,title:`Car 2`,group:`action`},{action:`crew3`,label:`3`,title:`Car 3`,group:`action`}]})}function Tf(e){let t=document.getElementById(`hud`);if(!t)return;let n=-1,r=()=>{let r=Math.ceil(t.getBoundingClientRect().bottom),i=Math.max(0,Math.min(r,window.innerHeight-120));i!==n&&(n=i,document.documentElement.style.setProperty(`--hud-band`,`${i}px`)),requestAnimationFrame(()=>{let t=document.getElementById(`game`);e?.(t?.clientWidth??0,t?.clientHeight??0)})};new ResizeObserver(r).observe(t),window.addEventListener(`resize`,r),window.addEventListener(`orientationchange`,r),r()}function Ef(e,t){let n=t?.stack||t?.message||String(t);console.error(`[crash:${e}] ${n}`);let r=document.getElementById(`crash`);r||(r=document.createElement(`pre`),r.id=`crash`,document.getElementById(`ui`)?.append(r)),r.textContent=`The game crashed (${e}).\n\n${n}`}window.addEventListener(`error`,e=>Ef(`error`,e.error||e.message)),window.addEventListener(`unhandledrejection`,e=>Ef(`promise`,e.reason));var Df=document.getElementById(`game`);Ju(Df);var Of=new xf(Df);Tf(()=>Of.resize());var kf=performance.now();function Af(e){try{let t=e-kf;kf=e,Of.update(t),Of.render()}catch(e){Ef(`frame`,e);return}window.requestAnimationFrame(Af)}window.requestAnimationFrame(Af);